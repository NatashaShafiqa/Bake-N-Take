      ...
      Glide.with(holder.img1.getContext()).load(model.getUrl()).into(holder.img1);
              ...
              holder.img1.setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View view) {
                      ...
                      activity.getSupportFragmentManager().beginTransaction().replace(R.id.wrapper,new descfragment(model.getUrl(),model.getName(),model.getDescription(),model.getPrice())).addToBackStack(null).commit();
                  }
              });
    }
