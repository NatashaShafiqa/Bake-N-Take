package com.example.BakeryApps.LoggedInUser;
...
import com.example.BakeryApps.HistoryMain;
import com.example.BakeryApps.HomePage;
import com.example.BakeryApps.Offer;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nav_history:
                startActivity(new Intent(this, HistoryMain.class));
                overridePendingTransition(0, 0);
                break;
